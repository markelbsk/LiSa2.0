...
images = {
    ...
    'x86_64_perl': {
        'run': f'{lisa_path}/images/x86_64_perl/run.sh',
        'prompt': '# ',
        'rootfs': f'{lisa_path}/images/x86_64_perl/images/rootfs.ext2'
    },
    'i386': {
    ...
    'm68k': {
        'run': f'{lisa_path}/images/m68k/run.sh',
        'prompt': '# ',
        'rootfs': f'{lisa_path}/images/m68k/images/rootfs.ext2'
    },
    'sparc': {
        'run': f'{lisa_path}/images/sparc/run.sh',
        'prompt': '# ',
        'rootfs': f'{lisa_path}/images/sparc/images/rootfs.ext2'
    },
    'sh4': {
        'run': f'{lisa_path}/images/sh4/run.sh',
        'prompt': '# ',
        'rootfs': f'{lisa_path}/images/sh4/images/rootfs.ext2'
    },
    'ppc': {
        'run': f'{lisa_path}/images/ppc/run.sh',
        'prompt': '# ',
        'rootfs': f'{lisa_path}/images/ppc/images/rootfs.ext2'
    }
}
