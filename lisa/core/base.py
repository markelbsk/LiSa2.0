...
class AnalyzedFile():
    ...
    def __init__(self, file_path, data_dir, exec_time=20, script_arch=None):
        self._path = os.path.abspath(file_path)
        self._name = os.path.basename(file_path)
        self._dir = os.path.dirname(self._path)
        self._data_dir = data_dir
        self._exec_time = exec_time
        self._script_arch = script_arch

        # get architecture info
        arch_info = get_architecture(file_path, script_arch)
    ...
    @property
    def script_arch(self):
        """Initial script architecture"""
        return self._script_arch
