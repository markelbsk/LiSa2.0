...
@celery_app.task(bind=True, base=LiSaBaseTask)
def full_analysis(self, file_path, pretty=False, exec_time=20, script_arch=None):
    """Full sandbox analysis task.

    :param file_path: Path to file.
    :param pretty: Output json indentation.
    :param exec_time: Execution time.
    :param script_arch: Architecture for the script launcher
    """
    ...
    master = Master(file_path, data_dir, exec_time, script_arch)
